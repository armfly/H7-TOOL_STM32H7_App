...
function config_cpu(void)
	...
	AlgoFile_FLASH =  "0:/H7-TOOL/Programmer/Device/ST/STM32L0xx/STM32L0xx_192.FLM"
	AlgoFile_EEPROM = "0:/H7-TOOL/Programmer/Device/ST/STM32L0xx/STM32L07_8x_EEPROM.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = "0:/H7-TOOL/Programmer/Device/ST/STM32L0xx/STM32L0xx_OPT.FLM"
	AlgoFile_QSPI  = ""

	FLASH_ADDRESS = 0x08000000		--CPU内部FLASH起始地址
	FLASH_SIZE = 192 * 1024			--芯片实际Flash Size小于FLM中的定义的size

	EEPROM_ADDRESS = 0x08080000
	EEPROM_SIZE = 6 * 1024			--芯片实际Flash Size小于FLM中的定义的size
