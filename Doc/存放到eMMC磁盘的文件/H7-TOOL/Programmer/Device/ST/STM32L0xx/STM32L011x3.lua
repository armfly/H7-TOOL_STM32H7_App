...
function config_cpu(void)
	...
	AlgoFile_FLASH =  "0:/H7-TOOL/Programmer/Device/ST/STM32L0xx/STM32L0xx_8.FLM"
	...
	FLASH_SIZE = 8 * 1024			--芯片实际Flash Size小于FLM中的定义的size

	EEPROM_ADDRESS = 0x08080000
	EEPROM_SIZE = 512				--芯片实际Size小于FLM中的定义的size
