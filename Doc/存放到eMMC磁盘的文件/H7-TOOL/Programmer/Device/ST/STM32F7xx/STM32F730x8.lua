...
function config_cpu(void)
	...
	AlgoFile_FLASH = "0:/H7-TOOL/Programmer/Device/ST/STM32F7xx/STM32F7x_64_AXI.FLM"
	AlgoFile_EEPROM = ""
	...
	OB_ADDRESS     =  "1FFF0000 1FFF0001 1FFF0008 1FFF0009 1FFF0010 1FFF0011 1FFF0018 1FFF0019"
					.."1FFF0020 1FFF0021 1FFF0028 1FFF0029 "
	OB_SECURE_OFF  = "FF AA FF FF 80 00 40 00 FF FF FF FF"	--SECURE_ENABLE = 0时，编程完毕后写入该值
	OB_SECURE_ON   = "FF 00 FF FF 80 00 40 00 FF FF FF FF"	--SECURE_ENABLE = 1时，编程完毕后写入该值
