...
function config_cpu(void)
	...
	AlgoFile_FLASH =  "0:/H7-TOOL/Programmer/Device/ST/STM32L1xx/STM32L1xx_128.FLM"
	AlgoFile_EEPROM = "0:/H7-TOOL/Programmer/Device/ST/STM32L1xx/STM32L1xx_128_EEPROM.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = "0:/H7-TOOL/Programmer/Device/ST/STM32L1xx/STM32L1xx_128_OPT.FLM"
	AlgoFile_QSPI  = ""

	FLASH_ADDRESS = 0x08000000		--CPU内部FLASH起始地址
	FLASH_SIZE = 128 * 1024			--芯片实际Flash Size小于FLM中的定义的size

	EEPROM_ADDRESS = 0x08080000
	EEPROM_SIZE = 4 * 1024			--芯片实际Flash Size小于FLM中的定义的size
	...
	OB_WRP_ADDRESS   = {0x1FF80000,
						0x1FF80008, 0x1FF80009, 0x1FF8000C, 0x1FF8000D} 	--内存地址
