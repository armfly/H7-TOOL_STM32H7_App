...
function config_cpu(void)
	...
	AlgoFile_FLASH =  "0:/H7-TOOL/Programmer/Device/ST/STM32L1xx/STM32L1xx_256.FLM"
	AlgoFile_EEPROM = "0:/H7-TOOL/Programmer/Device/ST/STM32L1xx/STM32L1xx_256_EEPROM.FLM"
	AlgoFile_OTP   = ""
	AlgoFile_OPT   = "0:/H7-TOOL/Programmer/Device/ST/STM32L1xx/STM32L1xx_256_OPT.FLM"
	AlgoFile_QSPI  = ""

	FLASH_ADDRESS = 0x08000000		--CPU内部FLASH起始地址
	FLASH_SIZE = 256 * 1024			--芯片实际Flash Size小于FLM中的定义的size

	EEPROM_ADDRESS = 0x08080000
	EEPROM_SIZE = 8 * 1024			--芯片实际Flash Size小于FLM中的定义的size
	...
	OB_WRP_ADDRESS   = {0x1FF80000,
						0x1FF80008, 0x1FF80009, 0x1FF8000C, 0x1FF8000D, 0x1FF80010, 0x1FF80011, 0x1FF80014, 0x1FF80015} 	--内存地址

	OB_WRP_MASK  	 = {0xFF,
						0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}		--读出数据与此数相与
	OB_WRP_VALUE 	 = {0xAA,
						0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}		--相与后与此数比较，相等表示没有保护
end
