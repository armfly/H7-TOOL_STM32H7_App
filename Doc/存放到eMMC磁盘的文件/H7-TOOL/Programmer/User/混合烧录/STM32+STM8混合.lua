--以下快捷方式将显示在PC软件界面(STM32)
--F01=自动编程,start_prog()
--F03=擦除MCU flash,erase_chip_mcu()
--F06=打印内存,print_flash(0x08000000,8)
--F07=打印UID,print_flash(UID_ADDR,12)
--F08=打印内核id,print_core_id()
--F09=修改RAM,pg_write_mem(0x20000000, "1234")
--F10=读回RAM,print_flash(0x20000000, 16)
--F12=硬件复位,pg_reset()
...
--下面的注释将显示在H7-TOOL液晶屏
Note01 = "STM32+STM8 四芯片烧录"

beep()

CHIP_NUM	= 4		--芯片个数

--4芯片对应的CHIP ID: STM32F407, STM8S003, STM32H750, STM32L051
CHIP_ID = {0x2BA01477, 0x67671003, 0x6BA02477, 0x0BC11477}
...
function cofig_chip1(void)	
	...
	--算法文件基准目录 (..是字符串连接符）
	FLM_DIR = "0:/H7-TOOL/Programmer/FLM/"
	...
	--STM32F4xx_1536.FLM
	--STM32F4xx_2048.FLM	
	AlgoFile_FLASH  = FLM_DIR.."ST/STM32F4xx/STM32F4xx_1024.FLM"
	...
	AlgoFile_OPT    = FLM_DIR.."ST/STM32F4xx/STM32F40xxx_41xxx_OPT.FLM"
	
	--STM32F4xx_OTP.FLM
	AlgoFile_OTP    = FLM_DIR.."ST/STM32F4xx/STM32F4xx_OTP.FLM"
	OTP_ADDRESS		= 0x1FFF7800

	--编程算法文件、数据文件、目标地址任务列表，可以任意追加
	...
	--OPTION BYTES 配置（STM32F405xx/07xx and STM32F415xx/17xx)
	...
	OB_RDP_OFF     = "FF AA FF FF"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "FF 00 FF FF"	--读保护的值，用于解除保护
...
function cofig_chip2(void)	
	...
	OB_RDP_OFF     = "00 00 00 00 00 00"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "AA 00 00 00 00 00"	--读保护的值，用于解除保护
		
	pg_reload_var()				--用于更新c程序的全局变量	
end

--配置芯片接口和参数（STM32H750 boot 和 App 2个文件)
function cofig_chip3(void)
	CHIP_TYPE = "SWD"		--指定器件接口类型: "SWD", "SWIM", "SPI", "I2C", "UART"	
...
--		0x90000000,								--目标地址		
	...
	--OPTION BYTES 配置 （STM32H743 750 暂时未实现，FLM暂时不支持）
	OB_ENABLE	= 0 				--1表示编程完毕后写OPTION BYTES
	...
	OB_RDP_OFF     = "F0AAC603  FF000000 FF000000 FF 00080000 FF000000 FF000000 FF"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "F000C603  FF000000 FF000000 FF 00080000 FF000000 FF000000 FF"	--读保护的值，用于解除保护
...
function cofig_chip4(void)	
	...
	--STM32L0xx_128.FLM
	--STM32L0xx_192.FLM
	AlgoFile_FLASH  = FLM_DIR.."ST/STM32L0xx/STM32L0xx_64.FLM"
	
	--STM32L0xx_OPT.FLM
	AlgoFile_OPT    = FLM_DIR.."ST/STM32L0xx/STM32L0xx_OPT.FLM"	
	
	--STM32L0xx_EEPROM.FLM
	--STM32L01_2x_EEPROM.FLM     STM32L011 and STM32L021
	--STM32L03_4x_EEPROM.FLM     STM32L031 and STM32L041
	--STM32L05_6x_EEPROM.FLM     STM32L051, STM32L052, STM32L062, STM32L053 and STM32L063	
	--STM32L07_8x_EEPROM.FLM     STM32L071, STM32L081, STM32L072, STM32L082, STM32L073 and STM32L083 devices (0x08080000)
	--STM32L07x_64_EEPROM.FLM    STM32L071, STM32L081, STM32L072, STM32L082, STM32L073 and STM32L083 devices (0x08080C00)
	AlgoFile_EEPROM    = ""
	...
	TaskList = {
		AlgoFile_FLASH,									--算法文件
		"0:/H7-TOOL/Programmer/User/TestBin/8K_55.bin",	--数据文件
		0x08000000,										--目标地址
	...
	OB_RDP_OFF     = "AA 00 70 80 00 00 00 00 00 00"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "00 00 70 80 00 00 00 00 00 00"	--读保护的值，用于解除保护
