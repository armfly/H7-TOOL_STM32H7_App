...
--选择芯片系列----------------------------------
--dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32SPIN0x/MM32SPIN05.lua")
dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32SPIN0x/MM32SPIN06.lua")
--dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32SPIN0x/MM32SPIN07.lua")
...
function config_chip1(void)
	...
	TaskList = {
		AlgoFile_FLASH,							--算法文件
		"0:/H7-TOOL/Programmer/User/TestBin/64K_5A.bin",  	--数据文件
		0x08000000,								--目标地址
	}
