...
--选择芯片系列----------------------------------
--dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32F031/MM32F031x4.lua")
--dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32F031/MM32F031x6.lua")
--dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32F031/MM32F031x8.lua")
dofile("0:/H7-TOOL/Programmer/Device/MindMotion/MM32F031/MM32F031xB.lua")
...
function config_chip1(void)
	...
	TaskList = {
		AlgoFile_FLASH,							--算法文件
		"0:/H7-TOOL/Programmer/User/TestBin/128K_5A.bin",  	--数据文件
		0x08000000,								--目标地址
	}
