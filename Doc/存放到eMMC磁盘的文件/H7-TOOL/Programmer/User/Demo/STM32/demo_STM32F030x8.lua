...
--dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F0xx/STM32F0xxx6.lua")
dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F0xx/STM32F0xxx8.lua")
--dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F0xx/STM32F0xxxB.lua")
--dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F0xx/STM32F0xxxC.lua")
...
function config_chip1(void)
	...
	if (MULTI_MODE == 0) then
		...
		SWD_CLOCK_DELAY = 30	--多路编程，根据实际板子调节，和CPU主频、电缆长度有关
	end
