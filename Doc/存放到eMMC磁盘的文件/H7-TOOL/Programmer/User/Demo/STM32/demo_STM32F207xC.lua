...
--选择芯片系列----------------------------------
--dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F7xx/STM32F74xxB.lua")
dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F7xx/STM32F74xxC.lua")
--dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F7xx/STM32F74xxE.lua")
--dofile("0:/H7-TOOL/Programmer/Device/ST/STM32F7xx/STM32F74xxF.lua")
...
function config_chip1(void)
	...
	if (SECURE_ENABLE == 1) then
		OB_VERIFY_DISABLE = 1			--1表示OB编程完毕后不验证（STM32F207加密读保护后无法读回校验）
	else
		OB_VERIFY_DISABLE = 0
	end
