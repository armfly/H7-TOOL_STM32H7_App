...
--下面的注释将显示在H7-TOOL液晶屏
Note01 = "STM32F746xG 测试程序"

beep()

--配置芯片接口和参数（STM32F746xG)
function cofig_chip1(void)	
	...
	--STM32F7x_64_AXI.FLM
	--STM32F7x_512.FLM
	--STM32F7x_512_TCM.FLM
	--STM32F7x_1024.FLM
	--STM32F7x_1024dual.FLM
	--STM32F7x_2048.FLM
	--STM32F7x_2048dual.FLM
	--STM32F7x_TCM.FLM
	--STM32F7x2_512.FLM
	--STM32F75x_64_AXI.FLM	
	----下面可不用	
	----STM32F7x_64_TCM.FLM	
	----STM32F75x_64_TCM.FLM
	----STM32F7x2TCM_512.FLM
	----STM32F7xTCM_1024.FLM
	----STM32F7xTCM_1024dual.FLM
	----STM32F7xTCM_2048.FLM
	----STM32F7xTCM_2048dual.FLM	
	AlgoFile_FLASH  = FLM_DIR.."ST/STM32F7xx/STM32F7x_1024.FLM"
	
	--STM32F7xx_OPT.FLM
	--STM32F72x_73x_OPT.FLM
	--STM32F74x_75x_OPT.FLM
	--STM32F76x_77x_OPT.FLM
	AlgoFile_OPT    = FLM_DIR.."ST/STM32F7xx/STM32F74x_75x_OPT.FLM"
	
	--STM32F7xx_OTP.FLM		
	--STM32F7x2_OTP.FLM	
	AlgoFile_OTP    = FLM_DIR.."ST/STM32F4xx/STM32F7xx_OTP.FLM"
	...
	--OPTION BYTES 配置（STM32F42xxx and STM32F43xxx)
	...
	OB_RDP_OFF     = "FF AA FF FF 80 00 40 00"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "FF 00 FF FF 80 00 40 00"	--读保护的值，用于解除保护
