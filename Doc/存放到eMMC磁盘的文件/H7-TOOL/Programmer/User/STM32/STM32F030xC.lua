...
function cofig_chip1(void)	
	...
	--STM32F0xx_128.FLM
	--STM32F0xx_256.FLM
	AlgoFile_FLASH  = FLM_DIR.."ST/STM32F0xx/STM32F0xx_256.FLM"
	
	--STM32F0xx_OPT.FLM
	AlgoFile_OPT    = FLM_DIR.."ST/STM32F0xx/STM32F0xx_OPT.FLM"	
	...
	TaskList = {
		AlgoFile_FLASH,
		"0:/H7-TOOL/Programmer/User/TestBin/256K_55.bin",	--数据文件 (""表示忽略)
		0x08000000,											--目标地址
	...
	OB_SECURE_OFF  = "AA FF FF FF FF FF FF FF"	--SECURE_ENABLE = 0时，编程完毕后写入该值	
	OB_SECURE_ON   = "00 FF FF FF FF FF FF FF"	--SECURE_ENABLE = 1时，编程完毕后写入该值
	
	OB_RDP_OFF     = "AA FF FF FF FF FF FF FF"	--OPTION缺省值,用于解除保护
