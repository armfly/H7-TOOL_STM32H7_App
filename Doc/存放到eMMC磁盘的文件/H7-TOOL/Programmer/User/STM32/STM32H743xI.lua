...
--F05=读SPI FLASH id, print_hex(pg_get_ext_id(0))
--F06=打印SPI FLASH,print_flash(0x90000000,16)
...
function cofig_chip1(void)
	...
	TaskList = {
		AlgoFile_FLASH,							--算法文件
		"0:/H7-TOOL/Programmer/User/TestBin/128K_55.bin",  	--数据文件
		0x08000000,								--目标地址
