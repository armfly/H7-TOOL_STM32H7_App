...
function cofig_chip1(void)	
	...
	--STM32F4xx_1536.FLM
	--STM32F4xx_2048.FLM	
	AlgoFile_FLASH  = FLM_DIR.."ST/STM32F4xx/STM32F4xx_2048.FLM"
	...
	AlgoFile_OPT    = FLM_DIR.."ST/STM32F4xx/STM32F42xxx_43xxx_OPT.FLM"
	...
	OB_SECURE_OFF  = "EF AA FF 3F FF FF FF FF"	--SECURE_ENABLE = 0时，编程完毕后写入该值	
	OB_SECURE_ON   = "EF 00 FF 3F FF FF FF FF"	--SECURE_ENABLE = 1时，编程完毕后写入该值
	
	OB_RDP_OFF     = "EF AA FF 3F FF FF FF FF"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "EF 00 FF 3F FF FF FF FF"	--读保护的值，用于解除保护
		
	--判断读保护和写保护的条件(WRP = Write protection)
	OB_WRP_ADDRESS   = {0x1FFFC001, 0x1FFFC008, 0x1FFFC009, 0x1FFEC008, 0x1FFEC009} 	--内存地址
	OB_WRP_MASK  	 = {0xFF, 0xFF, 0x0F, 0xFF, 0x0F}					--读出数据与此数相与
	OB_WRP_VALUE 	 = {0xAA, 0xFF, 0x0F, 0xFF, 0x0F}					--相与后与此数比较，相等表示没有保护
