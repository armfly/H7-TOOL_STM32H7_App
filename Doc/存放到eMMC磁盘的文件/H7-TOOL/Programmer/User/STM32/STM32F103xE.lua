...
function cofig_chip1(void)	
	...
	--STM32F10x_16.FLM   : STM32F10x Low-density Flash
	--STM32F10x_128.FLM  : STM32F10x Med-density Flash
	--STM32F10x_512.FLM  : STM32F10x High-density Flash
	--STM32F10x_1024.FLM : STM32F10x XL-density Flash
	--STM32F10x_CL.FLM   : STM32F10x Connectivity Line Flash	
	AlgoFile_FLASH  = FLM_DIR.."ST/STM32F10x/STM32F10x_512.FLM"
	
	--ST/STM32F10x/STM32F10x_OPT.FLM
	AlgoFile_OPT    = FLM_DIR.."ST/STM32F10x/STM32F10x_OPT.FLM"	
	...
	TaskList = {
		AlgoFile_FLASH,
		"0:/H7-TOOL/Programmer/User/TestBin/512K_55.bin",	--数据文件
		0x08000000,										--目标地址
		
		--下面可以追加文件（比如OTP一次性可编程文件)		
	}
		
	--1表示整片擦除，0表示按扇区擦除. 有些CPU（STM32F103,STM32F030）整片擦除速度快很多，有些慢很多
	ERASE_CHIP_ENABLE = 1
	...
	OB_RDP_OFF     = "A5 FF FF FF FF FF FF FF"	--OPTION缺省值,用于解除保护
	OB_RDP_ON      = "00 FF FF FF FF FF FF FF"	--读保护的值，用于解除保护
