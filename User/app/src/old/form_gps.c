...
typedef struct
{
	...
	LABEL_T Label1;	LABEL_T Label2;	/* 纬度 */
	LABEL_T Label3; LABEL_T Label4;	/* 经度 */
	LABEL_T Label5; LABEL_T Label6;	/* 速度 */
	LABEL_T Label7; LABEL_T Label8;	/* 海拔 */
	
	LABEL_T Label9; LABEL_T Label10;	/* 状态 */	
