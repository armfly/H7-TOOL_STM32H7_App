...
static __inline void PORT_SWD_SETUP(void)
{
	...
	gpio_init.Mode = GPIO_MODE_OUTPUT_PP;	/* …Ë÷√ø™¬© ‰≥ˆ */
	gpio_init.Pull = GPIO_NOPULL;			/* …œœ¬¿≠µÁ◊Ë≤ª πƒ‹ */
	gpio_init.Speed = GPIO_SPEED_FREQ_HIGH;	// GPIO_SPEED_FREQ_HIGH;  /* GPIOÀŸ∂»µ»º∂ */
...
static __inline void PORT_OFF(void)
{
	...
	gpio_init.Mode = GPIO_MODE_INPUT;	    /* …Ë÷√Œ™ ‰»Î */
	gpio_init.Pull = GPIO_NOPULL;			/* …œœ¬¿≠µÁ◊Ë≤ª πƒ‹ */
	gpio_init.Speed = GPIO_SPEED_FREQ_HIGH;	// GPIO_SPEED_FREQ_HIGH;  /* GPIOÀŸ∂»µ»º∂ */
...
//	gpio_init.Mode = GPIO_MODE_OUTPUT_PP;	/* …Ë÷√ø™¬© ‰≥ˆ */
//	gpio_init.Pull = GPIO_NOPULL;			/* …œœ¬¿≠µÁ◊Ë≤ª πƒ‹ */
//	gpio_init.Speed = GPIO_SPEED_FREQ_LOW;	// GPIO_SPEED_FREQ_HIGH;  /* GPIOÀŸ∂»µ»º∂ */
...
//	gpio_init.Mode = GPIO_MODE_INPUT;	    /* …Ë÷√ø™¬© ‰≥ˆ */
//	gpio_init.Pull = GPIO_NOPULL;			/* …œœ¬¿≠µÁ◊Ë≤ª πƒ‹ */
//	gpio_init.Speed = GPIO_SPEED_FREQ_LOW;	// GPIO_SPEED_FREQ_HIGH;  /* GPIOÀŸ∂»µ»º∂ */
...
//        /* Á°¨‰ª∂Â§ç‰ΩçÊó∂ÔºåÊâßË°åËΩØ‰ª∂Â§ç‰Ωç */
//        {
//            uint32_t val;
...
//            
//            /* ‰∏çÂÅöÂ§ç‰ΩçÈ∏£Âè´‰∫? ‰ΩìÈ™å‰∏çÂ•Ω */
//            //BEEP_Start(5, 1, 1); /* È∏£Âè´50msÔºåÂÅú10msÔº?1Ê¨?*/
//        }
    }
...
__inline void DAP_SETUP(void)
{
    ...
    BSP_SET_GPIO_1(GPIOE, GPIO_PIN_4); /* ËÆæÁΩÆ‰∏∫1 */
        
    EIO_D4_Config(ES_GPIO_IN);         /* RESET - ËæìÂÖ•„ÄÇ Áî®PG3ÊéßÂà∂ */
    EIO_D6_Config(ES_GPIO_OUT);        /* SWCLK - ËæìÂá∫ */
    EIO_D8_Config(ES_GPIO_OUT);        /* SWDIO - ËæìÂá∫ */
    EIO_D2_Config(ES_GPIO_OUT);        /* ÊµãËØïÂºïËÑö - ËæìÂá∫ */
    
    /* RESET Áî®PG3Êé®ÊåΩ Á°¨‰ª∂‰∏âÊûÅÁÆ°ÂºÄÊºèÂèçÂêë */	 
    BSP_SET_GPIO_0(GPIOG, GPIO_PIN_3);
    
	gpio_init.Speed = GPIO_SPEED_FREQ_HIGH;	// GPIO_SPEED_FREQ_HIGH;  /* GPIOÈÄüÂ∫¶Á≠âÁ∫ß */   
    gpio_init.Pull = GPIO_PULLUP;			
