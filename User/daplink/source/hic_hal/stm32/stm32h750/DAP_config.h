...
{
    BSP_SET_GPIO_1(GPIOG, GPIO_PIN_9);    /* PG9 = 1 ÂàáÊç¢‰∏∫ËæìÂá∫ÊñπÂêë */    
...
{
    BSP_SET_GPIO_0(GPIOG, GPIO_PIN_9);    /* PG9 = 0 ÂàáÊç¢‰∏∫ËæìÂÖ•ÊñπÂêë  */    
...
//    CONNECTED_LED_PORT->BSRR = CONNECTED_LED_PIN;
    EIO_D4_Config(ES_GPIO_OUT);        /* RESET -  ‰≥ˆ */
    EIO_D6_Config(ES_GPIO_OUT);        /* SWCLK -  ‰≥ˆ */
    EIO_D8_Config(ES_GPIO_OUT);        /* SWDIO -  ‰≥ˆ */
