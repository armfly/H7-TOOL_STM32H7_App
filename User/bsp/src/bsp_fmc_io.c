...
void bsp_InitExtIO(void)
{
	...
	EIO_ConfigPort(EIO_D10, ES_GPIO_IN);
	EIO_ConfigPort(EIO_D11, ES_GPIO_IN);
...
void EIO_SetOutLevel(uint8_t _eio, uint8_t _level)
{
	if (_level == 0)
	{
		if (_eio == EIO_D0) GPIO_SET_LOW(GPIOI, GPIO_PIN_0); 
		else if (_eio == EIO_D1) GPIO_SET_LOW(GPIOH, GPIO_PIN_10); 
		else if (_eio == EIO_D2) GPIO_SET_LOW(GPIOE, GPIO_PIN_6); 
		else if (_eio == EIO_D3) GPIO_SET_LOW(GPIOE, GPIO_PIN_5); 
		else if (_eio == EIO_D4) GPIO_SET_LOW(GPIOE, GPIO_PIN_4); 
		else if (_eio == EIO_D5) GPIO_SET_LOW(GPIOE, GPIO_PIN_2); 
		else if (_eio == EIO_D6) GPIO_SET_LOW(GPIOD, GPIO_PIN_3); 
		else if (_eio == EIO_D7) GPIO_SET_LOW(GPIOI, GPIO_PIN_6); 
		else if (_eio == EIO_D8) GPIO_SET_LOW(GPIOI, GPIO_PIN_3);
		else if (_eio == EIO_D9) GPIO_SET_LOW(GPIOD, GPIO_PIN_5);
		else if (_eio == EIO_D10) GPIO_SET_LOW(GPIOA, GPIO_PIN_9);
		else if (_eio == EIO_D11) GPIO_SET_LOW(GPIOA, GPIO_PIN_10);
		else if (_eio == EIO_D12) GPIO_SET_LOW(GPIOA, GPIO_PIN_12);
		
		else if (_eio == EIO_485_TXEN) GPIO_SET_LOW(GPIOI, GPIO_PIN_10);	
	}
	else if (_level == 1)
	{
		if (_eio == EIO_D0) GPIO_SET_HIGH(GPIOI, GPIO_PIN_0); 
		else if (_eio == EIO_D1) GPIO_SET_HIGH(GPIOH, GPIO_PIN_10); 
		else if (_eio == EIO_D2) GPIO_SET_HIGH(GPIOE, GPIO_PIN_6); 
		else if (_eio == EIO_D3) GPIO_SET_HIGH(GPIOE, GPIO_PIN_5); 
		else if (_eio == EIO_D4) GPIO_SET_HIGH(GPIOE, GPIO_PIN_4); 
		else if (_eio == EIO_D5) GPIO_SET_HIGH(GPIOE, GPIO_PIN_2); 
		else if (_eio == EIO_D6) GPIO_SET_HIGH(GPIOD, GPIO_PIN_3); 
		else if (_eio == EIO_D7) GPIO_SET_HIGH(GPIOI, GPIO_PIN_6); 
		else if (_eio == EIO_D8) GPIO_SET_HIGH(GPIOI, GPIO_PIN_3);
		else if (_eio == EIO_D9) GPIO_SET_HIGH(GPIOD, GPIO_PIN_5);
		else if (_eio == EIO_D10) GPIO_SET_HIGH(GPIOA, GPIO_PIN_9);
		else if (_eio == EIO_D11) GPIO_SET_HIGH(GPIOA, GPIO_PIN_10);		
		else if (_eio == EIO_D12) GPIO_SET_HIGH(GPIOA, GPIO_PIN_12);
		
		else if (_eio == EIO_485_TXEN) GPIO_SET_HIGH(GPIOI, GPIO_PIN_10);		
	}
}
...
uint8_t EIO_GetOutLevel(uint8_t _eio)
{
	...
	if (_eio == EIO_D0) if (GPIO_OUT_IS_HIGH(GPIOI, GPIO_PIN_0)) re = 1;
	if (_eio == EIO_D1) if (GPIO_OUT_IS_HIGH(GPIOH, GPIO_PIN_10)) re = 1;
	if (_eio == EIO_D2) if (GPIO_OUT_IS_HIGH(GPIOE, GPIO_PIN_6)) re = 1;
	if (_eio == EIO_D3) if (GPIO_OUT_IS_HIGH(GPIOE, GPIO_PIN_5)) re = 1;
	if (_eio == EIO_D4) if (GPIO_OUT_IS_HIGH(GPIOE, GPIO_PIN_4)) re = 1;
	if (_eio == EIO_D5) if (GPIO_OUT_IS_HIGH(GPIOE, GPIO_PIN_2)) re = 1;
	if (_eio == EIO_D6) if (GPIO_OUT_IS_HIGH(GPIOD, GPIO_PIN_3)) re = 1;
	if (_eio == EIO_D7) if (GPIO_OUT_IS_HIGH(GPIOI, GPIO_PIN_6)) re = 1;
	if (_eio == EIO_D8) if (GPIO_OUT_IS_HIGH(GPIOI, GPIO_PIN_3)) re = 1;
	if (_eio == EIO_D9) if (GPIO_OUT_IS_HIGH(GPIOD, GPIO_PIN_5)) re = 1;
	if (_eio == EIO_D10) if (GPIO_OUT_IS_HIGH(GPIOA, GPIO_PIN_9)) re = 1;
	if (_eio == EIO_D11) if (GPIO_OUT_IS_HIGH(GPIOA, GPIO_PIN_10)) re = 1;		
	if (_eio == EIO_D12) if (GPIO_OUT_IS_HIGH(GPIOA, GPIO_PIN_12)) re = 1;
	return re;
}
...
uint8_t EIO_GetInputLevel(uint8_t _eio)
{
	...
	if (_eio == EIO_D0) if (GPIO_IN_IS_HIGH(GPIOI, GPIO_PIN_0)) re = 1;
	if (_eio == EIO_D1) if (GPIO_IN_IS_HIGH(GPIOH, GPIO_PIN_10)) re = 1;
	if (_eio == EIO_D2) if (GPIO_IN_IS_HIGH(GPIOE, GPIO_PIN_6)) re = 1;
	if (_eio == EIO_D3) if (GPIO_IN_IS_HIGH(GPIOE, GPIO_PIN_5)) re = 1;
	if (_eio == EIO_D4) if (GPIO_IN_IS_HIGH(GPIOE, GPIO_PIN_4)) re = 1;
	if (_eio == EIO_D5) if (GPIO_IN_IS_HIGH(GPIOE, GPIO_PIN_2)) re = 1;
	if (_eio == EIO_D6) if (GPIO_IN_IS_HIGH(GPIOD, GPIO_PIN_3)) re = 1;
	if (_eio == EIO_D7) if (GPIO_IN_IS_HIGH(GPIOI, GPIO_PIN_6)) re = 1;
	if (_eio == EIO_D8) if (GPIO_IN_IS_HIGH(GPIOI, GPIO_PIN_3)) re = 1;
	if (_eio == EIO_D9) if (GPIO_IN_IS_HIGH(GPIOD, GPIO_PIN_5)) re = 1;
	
	if (_eio == EIO_D10) if (GPIO_IN_IS_HIGH(GPIOA, GPIO_PIN_9)) re = 1;
	if (_eio == EIO_D11) if (GPIO_IN_IS_HIGH(GPIOA, GPIO_PIN_10)) re = 1;		
	if (_eio == EIO_D12) if (GPIO_IN_IS_HIGH(GPIOA, GPIO_PIN_12)) re = 1;
	
	if (_eio == EIO_D13) if (GPIO_IN_IS_HIGH(GPIOA, GPIO_PIN_11)) re = 1;
...
uint8_t EIO_GetDir(uint8_t _eio)
{
	...
	if (_eio == EIO_D0) {if (GPIO_OUT_IS_HIGH(GPIO_D0_DIR, PIN_D0_DIR)) re = 1;}
	else if (_eio == EIO_D1) {if (GPIO_OUT_IS_HIGH(GPIO_D1_DIR, PIN_D1_DIR)) re = 1;}
	else if (_eio == EIO_D2) {if (GPIO_OUT_IS_HIGH(GPIO_D2_DIR, PIN_D2_DIR)) re = 1;}
	else if (_eio == EIO_D3) {if (GPIO_OUT_IS_HIGH(GPIO_D3_DIR, PIN_D3_DIR)) re = 1;}
	else if (_eio == EIO_D4) {if (GPIO_OUT_IS_HIGH(GPIO_D4_DIR, PIN_D4_DIR)) re = 1;}
	else if (_eio == EIO_D5) {if (GPIO_OUT_IS_HIGH(GPIO_D5_DIR, PIN_D5_DIR)) re = 1;}
	else if (_eio == EIO_D6) {if (GPIO_OUT_IS_HIGH(GPIO_D6_DIR, PIN_D6_DIR)) re = 1;}
	else if (_eio == EIO_D7) {if (GPIO_OUT_IS_HIGH(GPIO_D7_DIR, PIN_D7_DIR)) re = 1;}
	else if (_eio == EIO_D8) {if (GPIO_OUT_IS_HIGH(GPIO_D8_DIR, PIN_D8_DIR)) re = 1;}
	else if (_eio == EIO_D9) {if (GPIO_OUT_IS_HIGH(GPIO_D9_DIR, PIN_D9_DIR)) re = 1;}
	
	else if (_eio == EIO_D10) {re = 0;}	/* TTL-RX */
	else if (_eio == EIO_D11) {re = 1;}	/* TTL-TX */
	else if (_eio == EIO_D12) {re = 1;}	/* CAN-TX */	
	else if (_eio == EIO_D13) {re = 0;}	/* CAN-RX */
